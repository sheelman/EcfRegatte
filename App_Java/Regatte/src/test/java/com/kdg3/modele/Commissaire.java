 ...
 */
@MappedSuperclass
@Table(name = "commissaire")
@XmlRootElement
public class Commissaire implements Serializable {
    ...
    @JoinColumn(name = "id_comite", referencedColumnName = "id")
    @ManyToOne(optional = false)
    private Comite idComite;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "idCommissaire")
    private Collection<Pointe> pointeCollection;

    public Commissaire() {
    }

    public Commissaire(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Commissaire)) {
            return false;
        }
        Commissaire other = (Commissaire) object;
    ...
    public String toString() {
        return "com.kdg3.DAO.Commissaire[ id=" + id + " ]";
    }
