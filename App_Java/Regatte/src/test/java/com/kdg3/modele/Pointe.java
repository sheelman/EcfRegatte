...
public class Pointe implements Serializable {
    ...
    @Column(name = "id")
    private Integer id;
    @JoinColumn(name = "id_commissaire", referencedColumnName = "id")
    @ManyToOne(optional = false)
    private Commissaire idCommissaire;
    ...
    public Commissaire getIdCommissaire() {
        return idCommissaire;
    }

    public void setIdCommissaire(Commissaire idCommissaire) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Pointe)) {
            return false;
        }
        Pointe other = (Pointe) object;
    ...
    public String toString() {
        return "com.kdg3.DAO.Pointe[ id=" + id + " ]";
    }
